...
const SignUp = () => {
  ...
  return (
    <div className=" flex bg-dimWhite dark:bg-fadeMidNight py-6">
      <div className="w-full max-w-md m-auto bg-white dark:bg-midnight rounded-lg shadow-default py-10 px-16">
        ...
        <form onSubmit={handleFormSubmit}>
          ...
          <div className="flex items-center pt-4 space-x-1 mt-5">
            ...
            <p className="px-3 text-sm text-midnight dark:text-white">Sign Up with social accounts</p>
            <div className="flex-1 h-px sm:w-16 dark:bg-gray-700"></div>
          </div>
          ...
          <p className="text-xs text-center sm:px-6 text-midnight dark:text-white">
            ...
            <Link rel="noopener noreferrer" to="/login" className="underline dark:text-gray-100">
              Login
            </Link>
          </p>
        </form>
